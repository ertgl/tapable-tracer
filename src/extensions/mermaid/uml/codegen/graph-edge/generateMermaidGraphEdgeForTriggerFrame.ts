import type { EncodableTriggerFrame } from "../../../../../stack-frame/encodable/EncodableTriggerFrame";
import { LABEL_ROOT } from "../../../labels/LABEL_ROOT";
import type { MermaidGraphCodeGenState } from "../graph/state/MermaidGraphCodeGenState";

export function generateMermaidGraphEdgeForTriggerFrame(
  state: MermaidGraphCodeGenState,
  frame: EncodableTriggerFrame,
): string
{
